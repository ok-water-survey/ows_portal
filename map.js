...
//var verDate={"0":"0.01","1":"20 August 2012"};
...
$(window).load(function() {
	...
	ccbasemap = new OpenLayers.Layer.XYZ("ccbasemap", "http://129.15.41.144:8080/ccbasemap/${z}/${x}/${y}.png", { 'sphericalMercator' : true });
       ...
       /* geojson_layer = new OpenLayers.Layer.Vector("GeoJSON", {
        ...
        /*kml_layer = new OpenLayers.Layer.Vector("KML", {
            projection:options.displayProjection,
            strategies: [new OpenLayers.Strategy.Fixed()],
            protocol: new OpenLayers.Protocol.HTTP({
                url: "gw.kml",
        ...
        //geojson_layer.transform(options.displayProjection,options.projection);
        glayers= [
    ...
    floraLayer = new OpenLayers.Layer.Vector("USGS Active Sites", {styleMap: floraStyles});
...
$(document).ready( function() {
	...
	$("#advSearch").dialog({ autoOpen:false, title: "Advanced Search", height:800, width:800, position: [400,100],
		 buttons: [
		           ...
		           { text: "Search",  class: "btn btn-success", click: function() { doAdvSearch(); $(this).dialog("close"); } } ] 
	});
...
//Site Description==========================================================================================
	...
	if (Preservetype.length>0) {
		if (preserveOther) {
			qry+="{'Preservetype':{'$nin':['Park','Forest','Wildlife Management','Wilderness','Natural Area - NRA','Recreation Area','Mixed','Monument','Experimental Site or Research Site','Wildlife Refuge']}},";
		}else{
